...
public:
	CSmartCoord();
	CSmartCoord(double xx, double yy);
	CSmartCoord(dbl_pair dPair);
	CSmartCoord(const CSmartCoord& other);
	~CSmartCoord();
	...
	/* Math operations */
	CSmartCoord& operator=(const CSmartCoord& other);
	CSmartCoord& operator+=(const CSmartCoord& other);
	CSmartCoord& operator-=(const CSmartCoord& other);
...
double CSmartCoord::xDeg() const { return m_xDeg; }
double CSmartCoord::yDeg() const { return m_yDeg; }
double CSmartCoord::xStimDeg() const { return m_xStimDeg; }
double CSmartCoord::yStimDeg() const { return m_yStimDeg; }
double CSmartCoord::xScreenDeg() const { return m_xScreenDeg; }
double CSmartCoord::yScreenDeg() const { return m_yScreenDeg; }
double CSmartCoord::xScreenPix() const { return m_xScreenPix; }
double CSmartCoord::yScreenPix() const { return m_yScreenPix; }
