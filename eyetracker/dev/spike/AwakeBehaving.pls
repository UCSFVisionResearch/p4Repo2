...
;
;Digital Inputs
;[7.......] pin 5  - VSG pin 1 - VSG Dig out 0 - 1=calibration/non behavioral contingent gratings trial | 0 = behavioral contingent gratings trial
...
;
;Last modified
;9/29/16 JW fix rewards state for calibration  (non behavioral contingency) 
...
TEST:       DIBEQ  [1..0.0..],CMPEITH ; Non behavioral contingent and both eyes open, compare either eye
			DIBEQ  [...0.1..],CMPREYE ;right eye open, left eye closed
