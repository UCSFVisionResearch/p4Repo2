...
public:
	...
	afx_msg void OnBnClickedStimRightEye();
	afx_msg void OnBnClickedStimLeftEye();
	afx_msg void OnBnClickedShowRightEye();
	afx_msg void OnBnClickedShowLeftEye();
	afx_msg	void OnBnClickedSaveGrid();
	...
	CEdit   m_CrossPix;
	CEdit   m_CenterXPosPrim;
	CEdit   m_CenterYPosPrim;
	CEdit   m_CenterXPosSec;
	CEdit   m_CenterYPosSec;
	...
	CSliderCtrl m_DifficultySlider;
	CStatic m_DifficultyDescription;
	...
	CButton m_StimRightEye;
	CButton m_StimLeftEye;
	CButton m_ShowRightEye;
	CButton m_ShowLeftEye;
	CButton m_SaveGrid;
	CEdit   m_AngleOffset;
	CEdit	m_AngleFlux;
	CButton m_Angle0;
...
private:
	...
	void UpdateDifficultyDescription(int lev);
	...
	/* Stores the slider difficulty when switching to spatiotopic. */
	int m_previousDifficulty;
};
