...
public:
	...
	int getAngleFlux() const;
	void setAngleFlux(int angleFlux);

	bool getStimRightEye() const;
	void setStimRightEye(bool checked);
	bool getStimLeftEye() const;
	void setStimLeftEye(bool checked);
	...
	int getRadiusFlux() const;
	void setRadiusFlux(int radiusFlux);
	...
	int getAngleOffsetL() const;
	void setAngleOffsetL(int angleOffset);

	int getAngleFluxL() const;
	void setAngleFluxL(int angleFlux);


	bool getAngle0L() const;
	bool getAngle45L() const;
	bool getAngle90L() const;
	bool getAngle135L() const;
	bool getAngle180L() const;
	bool getAngle225L() const;
	bool getAngle270L() const;
	bool getAngle315L() const;

	void setAngle0L(bool checked);
	void setAngle45L(bool checked);
	void setAngle90L(bool checked);
	void setAngle135L(bool checked);
	void setAngle180L(bool checked);
	void setAngle225L(bool checked);
	void setAngle270L(bool checked);
	void setAngle315L(bool checked);

	int getRadiusOffsetL() const;
	void setRadiusOffsetL(int radiusOffset);

	int getRadiusFluxL() const;
	void setRadiusFluxL(int radiusFlux);

	bool getRadiusOriginL() const;
	bool getRadius0L() const;
	bool getRadius5L() const;
	bool getRadius10L() const;
	bool getRadius15L() const;
	bool getRadius20L() const;
	bool getRadius25L() const;
	bool getRadius30L() const;

	void setRadiusOriginL(bool checked);
	void setRadius0L(bool checked);
	void setRadius5L(bool checked);
	void setRadius10L(bool checked);
	void setRadius15L(bool checked);
	void setRadius20L(bool checked);
	void setRadius25L(bool checked);
	void setRadius30L(bool checked);
...
private:
	...
	etu::pGrid_t MakePeripheralGridL();
	void CleanUpTrials();
