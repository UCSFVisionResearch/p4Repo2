...
public:
	...
	inline float getCirFreq();
	inline void setCirFreq(float f);

	inline float getCirAmp();
	inline void setCirAmp(float f);
};
...
float CFullfield::getCirFreq() { return fCirFreq; }
void CFullfield::setCirFreq(float f) { fCirFreq = f; }

float CFullfield::getCirAmp() { return fCirAmp; }
void CFullfield::setCirAmp(float f) { fCirAmp = f; }
