...
public:
	...
	void setColors(const VSGTRIVAL& bgColor, const VSGTRIVAL& binocNoiseColor);
	void getColors(VSGTRIVAL& bgColor, VSGTRIVAL& binocNoiseColor) const;

	void setColors(const VSGTRIVAL& bgColor, const VSGTRIVAL& binocNoiseColor, 
		const VSGTRIVAL& leftNoiseColor, const VSGTRIVAL& rightNoiseColor);
	void getColors(VSGTRIVAL& bgColor, VSGTRIVAL& binocNoiseColor, 
		VSGTRIVAL& leftNoiseColor, VSGTRIVAL& rightNoiseColor) const;

	void setLutBase(int lutBase);
	int getLutBase();

	void setBinocPercent(int percent);
	int getBinocPercent();
...
private:
	...
	VSGTRIVAL m_bgColor;
	VSGTRIVAL m_binocNoiseColor;
	VSGTRIVAL m_leftNoiseColor;
	VSGTRIVAL m_rightNoiseColor;
	int m_binocPercent;
	int m_leftPercent;
	int m_rightPercent;
	int m_bgPercent;
...
long drawCircle(int xPix, int yPix, int sizePix,
				NoiseColorMap* colorMap,long level, NoiseBgController* bgCont);
...
long drawCross(int xPix, int yPix, int sizePix, int thickPix,long level, NoiseColorMap* colorMap, 
