...
private:
	...
	inline CCoordinate& fixPoint(bool left);

	VSGTRIVAL m_bgColor;
	VSGLUTBUFFER m_lutBuffer;

	CCoordinate m_leftFixPoint;
	CCoordinate m_rightFixPoint;
...
CCoordinate& CGratingsStimulus::fixPoint(bool left)
{
	return (left ? m_leftFixPoint : m_rightFixPoint);
}
