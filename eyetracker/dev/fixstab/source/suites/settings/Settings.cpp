 ...
 */
CCoordinate::CCoordinate(double xx, double yy)
{
	set(xx, yy);
}
 ...
 */
CCoordinate::CCoordinate(dbl_pair dPair)
{
 ...
 * @param yy Y coordinate in degrees.
 */
void CCoordinate::set(double xx, double yy)
{
	m_xDeg = xx;
	m_yDeg = yy;
 ...
 *
 * Not a friend of the CCoordinate class because it uses the public += 
