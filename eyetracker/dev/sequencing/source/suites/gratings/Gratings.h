...
protected:
	...
	float fXLocL, fYLocL, fXLocR, fYLocR, fDotSize, fGratingWidth, fGaborSD, fStaticPhase, fStaticAngle, fStepSize,
...
public:
	...
	float getX(bool left) {return (left)? fXLocL : fXLocR;}
	float getY(bool left) {return (left)? fYLocL : fYLocR;}

	float getXLeft() {return fXLocL;}
	void setXLeft(float f) {fXLocL=f;}
	float getYLeft() {return fYLocL;}
	void setYLeft(float f) {fYLocL=f;}
	float getXRight() {return fXLocR;}
	void setXRight(float f) {fXLocR=f;}
	float getYRight() {return fYLocR;}
	void setYRight(float f) {fYLocR=f;}
