...
public:
	...
	/* Sequencing ***********************************************************/
	int getInitTimeMin() const;
	int getInitTimeMax() const;

	int getFlashTimeMin() const;
	int getFlashTimeMax() const;

	int getDelayTimeMin() const;
	int getDelayTimeMax() const;

	int getHoldTime() const;
	int getBaitedTime() const;

	void setInitTimeMin(int i);
	void setInitTimeMax(int i);

	void setFlashTimeMin(int i);
	void setFlashTimeMax(int i);

	void setDelayTimeMin(int i);
	void setDelayTimeMax(int i);

	void setHoldTime(int i);
	void setBaitedTime(int i);
	...
	float getCenterXPos() const;
	void setCenterXPos(float f);

	float getCenterYPos() const;
...
private:
	...
	int iPrimaryRed, iPrimaryGreen, iPrimaryBlue,		//red
		...
		iWrongDelay, iMisbehaviorDelay,	//times for blank screens
	...
	bool bUseNoise, bInterleaveNoise,					//noise options
		bAvoidZero, bCenterPoints, bOffAxis, bUseShapes, bSameBG, bOccludeBG, bDotGratings;

	int m_initTimeMin, m_initTimeMax;
	int m_flashTimeMin, m_flashTimeMax;
	int m_delayTimeMin, m_delayTimeMax;
	int m_baitedTime;
	int m_holdTime;
