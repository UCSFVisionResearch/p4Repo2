...
{
	int randX = etu::RandChoice(0, m_numCtrLocations - 1);
	int randY = etu::RandChoice(0, m_numCtrLocations - 1);
...
void CScotomaMap::GenerateTrials() 
{
	...
	if (gridPct) {
		...
		const long numGridPoints = (long)(gridPct * 100) * pointsOnGrid;
